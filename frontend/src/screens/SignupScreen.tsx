      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.card}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Join TaskSphere to optimize your workflow in seconds.</Text>
          </View>
          ...
          <View style={styles.form}>
            <Controller
              ...
              render={({ field: { value, onChange } }) => (
                <Input label="Full Name" value={value} onChangeText={onChange} placeholder="John Doe" />
              )}
            />
            ...
            {!!mutation.error && <Text style={styles.formError}>{getErrorMessage(mutation.error, "Could not create account")}</Text>}
